...
@AutoSpellConfig
public class ThermalSunderIceSpell extends AbstractSpell {
    private final ResourceLocation spellId = new ResourceLocation(PowerOfTheVoid.MODID, "thermal_sunder_ice");
